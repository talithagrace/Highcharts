<p># Highcharts</p>
<p>Examples of data visualisations using Highcharts</p>
<p>This repository contains an example of a chart which uses data located in CSV files. Using Highcharts click point event function,
users can drill down on points on the chart to reveal charts which also use CSV source data.</p>
